                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" required class="form-control"
                          ...
                          placeholder="Enter student's full name"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control"
                          ...
                          placeholder="Enter email address"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="phone" id="phone" class="form-control"
                            ...
                            placeholder="Enter phone number"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="dob" id="dob" required class="form-control"
                          value="<?php echo isset($student) ? ($student['school_student_dob'] ?? '') : (isset($old['dob']) ? $old['dob'] : ''); ?>"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="calculated-age" class="form-control" readonly
                          ...
                          placeholder="Will be calculated from DOB"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      
                      <div class="form-group">
                        <label for="profile_photo" class="control-label">Profile Photo</label>
                        <input type="file" name="profile_photo" id="profile_photo" class="form-control" accept="image/*"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                        <?php if(isset($student) && !empty($student['id'])): ?>
                          <div class="current-photo" style="margin-top: 10px;">
                            <img src="<?php echo admin_url('student_sponsor_portal/display_school_photo/' . (int)$student['id']); ?>"
                                ...
                                onerror="this.style.display='none'"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php if(isset($is_university_student) && $is_university_student): ?>
                          ...
                          <select name="country_id" id="country_id" class="form-control selectpicker" data-live-search="true" data-none-selected-text="Select Country"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : 'raju'; ?>>
                        ...
                        <?php else: ?>
                          ...
                          <div class="country-select-wrapper">
                            <select name="country_id" id="country_id" class="form-control selectpicker" data-live-search="true" data-none-selected-text="Select Country"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                              <option value="">Select Country</option>
      <?php 
  if(!empty($countries)): 
  ...
  <?php endforeach; endif; ?>
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="address" id="address" class="form-control" rows="3" placeholder="Complete address"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>><?php echo isset($student) ? html_escape($student['address'] ?? '') : (isset($old['address']) ? html_escape($old['address']) : ''); ?></textarea>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="city" id="city" class="form-control"
                              ...
                              placeholder="City / District"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="postal_code" id="postal_code" class="form-control"
                              ...
                              placeholder="Postal code"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="school_id" id="school_id" class="form-control"
                          ...
                          placeholder="Enter school student ID"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="grade" id="grade" class="form-control"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
    ...
    <select name="school_type" id="school_type" class="form-control"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="school-select-wrapper">
                          <select id="school_name_id" name="school_name_id" class="form-control selectpicker" data-live-search="true" data-none-selected-text="Select School"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php if(isset($is_school_student) && $is_school_student): ?>
                          ...
                          <select name="bank_id" id="bank_id" class="form-control selectpicker" data-live-search="true" data-none-selected-text="Select Bank"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="bank_account_number" id="bank_account_number" class="form-control"
                          ...
                          placeholder="Account number"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="bank_branch_number" id="bank_branch_number" class="form-control"
                          ...
                          placeholder="Branch code/number"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      <div class="form-group">
                        <label for="bank_branch_info" class="control-label">Bank Branch Information</label>
                        <textarea name="bank_branch_info" id="bank_branch_info" class="form-control" rows="3" placeholder="Additional branch details"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>><?php echo isset($student) ? html_escape($student['school_bank_branch_info'] ?? '') : (isset($old['bank_branch_info']) ? html_escape($old['bank_branch_info']) : ''); ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="father_name" id="father_name" class="form-control"
                          value="<?php echo isset($student) ? html_escape($student['school_father_name'] ?? '') : (isset($old['father_name']) ? html_escape($old['father_name']) : ''); ?>"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="father_income" id="father_income" class="form-control"
                          ...
                          placeholder="Monthly income"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="mother_name" id="mother_name" class="form-control"
                          value="<?php echo isset($student) ? html_escape($student['school_mother_name'] ?? '') : (isset($old['mother_name']) ? html_escape($old['mother_name']) : ''); ?>"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="guardian_name" id="guardian_name" class="form-control"
                          value="<?php echo isset($student) ? html_escape($student['school_guardian_name'] ?? '') : (isset($old['guardian_name']) ? html_escape($old['guardian_name']) : ''); ?>"<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="background_information" id="background_information" class="form-control" rows="3" 
                          placeholder="Student background, family situation, etc."<?php echo (isset($is_school_student) && $is_school_student) ? 'disabled' : ''; ?>><?php echo isset($student) ? html_escape($student['background_info'] ?? '') : (isset($old['background_information']) ? html_escape($old['background_information']) : ''); ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
