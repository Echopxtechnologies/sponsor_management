          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <p class="text-muted">Import multiple university students from Excel or CSV files</p>
              </div>
            ...
            <div class="alert alert-info">
              ...
              <ul style="margin-bottom: 0;">
                ...
                <li><strong>Year of Study:</strong> Use format 1Y1S, 1Y2S, 2Y1S, 2Y2S, etc.</li>
              </ul>
            </div>
            ...
            <!-- Upload Form -->
            <?php echo form_open_multipart(admin_url('student_sponsor_portal/bulk_import_university_students'), ['id' => 'import-form']); ?>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <ul class="list-unstyled">
                      ...
                      <li><i class="fa fa-plus text-info"></i> Create universities/programs/banks if not found</li>
                      ...
                      <li><i class="fa fa-graduation-cap text-warning"></i> Year of study validation</li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <ul class="list-unstyled small">
                          <li>• University ID, Internal ID</li>
                          <li>• University, Program</li>
                          <li>• Year of Study (1Y1S, 1Y2S, etc.)</li>
                        </ul>
                      </div>
                      <div class="col-md-4">
...
$(document).ready(function() {
  ...
  $('#import-form').on('submit', function(e) {
    ...
    if (!confirm('Are you sure you want to import this ' + fileType + ' file? This will add/update university student records in the database.')) {
      e.preventDefault();
      return false;
    }
