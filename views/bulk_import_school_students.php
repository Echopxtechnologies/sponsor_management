          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <p class="text-muted">Import multiple school students from Excel or CSV files</p>
              </div>
            ...
            <div class="alert alert-info">
              ...
              <ul style="margin-bottom: 0;">
                ...
                <li><strong>Step 2:</strong> Fill in your student data using the template</li>
                ...
                <li><strong>Updates:</strong> Students with existing email/internal ID will be updated</li>
                <li><strong>Age validation:</strong> Applies for grades 1-10 (O/L and A/L are exempt)</li>
              </ul>
            </div>
            ...
            <div class="row" style="margin-bottom: 20px;">
              ...
              <div class="col-md-4">
                <div class="format-support">
                  ...
                  <h6>20MB Max Size</h6>
                  <p class="text-muted">Support for large student databases</p>
                </div>
              </div>
            </div>

            <!-- Upload Form -->
            <?php echo form_open_multipart(admin_url('student_sponsor_portal/bulk_import_school_students'), ['id' => 'import-form']); ?>
            ...
            <div class="form-group">
              <div class="checkbox checkbox-primary">
                ...
                <label for="confirm_backup">
                  I understand that this import will add/update student records and I have backed up my data
                </label>
              </div>
            </div>
            ...
            <div class="row" style="margin-top: 40px;">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <ul class="list-unstyled">
                      <li><i class="fa fa-check text-success"></i> <strong>Name</strong> - Student's full name</li>
                      <li><i class="fa fa-info-circle text-info"></i> Email (recommended for updates)</li>
                      <li><i class="fa fa-info-circle text-info"></i> Internal ID (auto-generated if empty)</li>
                    </ul>
                    <small class="text-muted">
              ...
              <div class="col-md-6">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <ul class="list-unstyled">
                      <li><i class="fa fa-refresh text-success"></i> Update existing students automatically</li>
                      <li><i class="fa fa-plus text-info"></i> Create schools/banks if not found</li>
                      <li><i class="fa fa-shield text-warning"></i> Age-grade validation for grades 1-10</li>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <ul class="list-unstyled small">
                          <li>• School ID, Internal ID</li>
                          <li>• Grade (1-10, O/L, A/L1, A/L2)</li>
                          <li>• School Type, School Name</li>
                          <li>• Grade Mismatch Reason</li>
                        </ul>
                      </div>
                      <div class="col-md-4">
...
$(document).ready(function() {
  ...
  $('#import-form').on('submit', function(e) {
    ...
    if (!confirm('Are you sure you want to import this ' + fileType + ' file? This will add/update student records in the database.')) {
      e.preventDefault();
      return false;
    }
    ...
    var progressInterval = setInterval(function() {
      ...
      if (progress > 85) progress = 85; // Don't complete until actually done
      $('.progress-bar').css('width', progress + '%');
    }, 500);
    
    // Store interval to clear it when form submission completes
    this.progressInterval = progressInterval;
  });
  
  // File input change handler for validation and preview
  ...
  // Clear any progress indicators on page load
